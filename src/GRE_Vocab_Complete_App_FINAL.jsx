...
// Get word info from 1100-word dictionary (exact match only)
const getWordInfo = (word) => {
    if (!word) return null;
    const lower = word.toLowerCase();
    const exactKey = Object.keys(WORD_DICTIONARY).find(k => k.toLowerCase() === lower);
    return exactKey ? WORD_DICTIONARY[exactKey] : null;
};
